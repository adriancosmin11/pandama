                    ...
                    <div className="fixed inset-0 z-[100] flex items-start justify-center px-6 pt-24 pb-12 overflow-y-auto">
                        ...
                        >
                            ...
                            <div className="lg:w-1/2 p-8 pt-10 lg:p-16 text-white flex flex-col justify-center">
                                <div className="mb-4 lg:mb-6 text-[8px] lg:text-[10px] font-black uppercase tracking-[0.4em] text-primary bg-primary/10 px-4 py-1.5 rounded-full border border-primary/20 inline-block w-fit">
